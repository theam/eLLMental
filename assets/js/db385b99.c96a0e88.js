...
direct message to any of the administrators in our official `,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://discord.gg/ZajFQEjgFw"},`Discord server`),`. All reports
...
contribute and reduces the chance of duplicate work.`),(0,esm/* mdx */.kt)("h2",{"id":"creating-a-release"},`Creating a release`),(0,esm/* mdx */.kt)("p",null,`When a release is created in Github, that will trigger an automated Github Action that will publish the new version to maven central.
Make sure to set up a release tag that follows the `,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://semver.org/"},`semantic versioning`),` standard, using the format `,(0,esm/* mdx */.kt)("inlineCode",{parentName:"p"},`<major>.<minor>.<patch>`),`,
